...
from zero to full-throttle\cite{hid-sp18-602-www-loadbalancing-main}. 
Google Load balancing support different flavors such as HTTP,TCP/SSL and UDP 
Load Balancing\cite{hid-sp18-602-www-loadbalancing-main}. Also the new UI enables users 
to integrate any of these flavors easily through a single interface.
