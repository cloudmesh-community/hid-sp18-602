...
workflows.~\cite{hid-sp18-602-spinnaker-io} The main advantage of
...
Schibsted, Armory and Kenzan.~\cite{hid-sp18-602-spinnaker-gc}\footnote{Please check citation rules.}
